...
class socketConnections(QtWebsocket, mainGUI.Ui_MainWindow):
    ...
    def updatePrintStatus(self, file):
        ...
        try:
            ...
            error_message = f"Error in updatePrintStatus function: {str(e)}"
            log_error(error_message)
            if dialog.WarningOk(self, error_message, overlay=True):
                pass
    ...
    def softwareUpdateResult(self, data):
        try:
            ...
            error_message = f"Error in softwareUpdateResult function: {str(e)}"
            log_error(error_message)
            if dialog.WarningOk(self, error_message, overlay=True):
                pass
    ...
    def softwareUpdateProgress(self, data):
        try:
            ...
            error_message = f"Error in softwareUpdateProgress function: {str(e)}"
            log_error(error_message)
            if dialog.WarningOk(self, error_message, overlay=True):
                pass
    ...
    def softwareUpdateProgressLog(self, data):
        try:
            ...
            error_message = f"Error in softwareUpdateProgressLog function: {str(e)}"
            log_error(error_message)
            if dialog.WarningOk(self, error_message, overlay=True):
                pass
    ...
    def updateFailed(self, data):
        try:
            ...
            error_message = f"Error in updateFailed function: {str(e)}"
            log_error(error_message)
            if dialog.WarningOk(self, error_message, overlay=True):
                pass
